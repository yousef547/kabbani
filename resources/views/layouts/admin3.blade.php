...
<head>
    ...
    <title> Kabbani Dashboard </title>
    
    <link rel="apple-touch-icon" href="{{ asset('kabbani/assets/admin/images/ico/apple-icon-120.jpg') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('kabbani/assets/admin/images/ico/logo.jpg') }}">
    <link
...
<script src="{{asset('kabbani/assets/admin/vendors/js/forms/icheck/icheck.min.js')}}" type="text/javascript"></script>
...
<script>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDLi_lqeBs3scnLK-VNOzOZSPlUyZ1k5pM&callback=initMap&libraries=&v=weekly"async>
    </script>
</body>
</html>
