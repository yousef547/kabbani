                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> Edit {{ $recommended_product->product->product_name }} </h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.recommended_products.update',$recommended_product->id) }}" method="POST">
                                        @csrf                                        
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-home"></i> Recommended Product </h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> Product Id </label>
                                                        <select name="product_id" id="product_id" class="custom-select">
                                                            <option value="{{ $recommended_product->product->id }}">{{ $recommended_product->product->product_name }}</option>    
                                                        </select>
                                                        @error("product_id")
