                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.sellers.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-home"></i> Sellers Data </h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group"> 
                                                        <label> Seller Name </label>
                                                        <input type="text" value="" id="seller_name"
                                                               class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group"> 
                                                        ...
                                                        <input type="text" value="" id="seller_ar"
                                                               class="form-control"
                                                               placeholder="Ex: جون سميث "
                                                               name="seller_ar">
                                                        @error("seller_ar")
                                                         <span class="text-danger">{{ $message }}</span>
                                                         @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="" id="store_name"
                                                               class="form-control"
                                                               placeholder="Ex: El3almia Fruniture"
                                                               name="store_name">
                                                        @error("store_name")
                                                         <span class="text-danger">{{ $message }}</span>
                                                         @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="" id="store_ar"
                                                               class="form-control"
                                                               placeholder="Ex: العالمية للأثاث"
                                                               name="store_ar">
                                                        @error("store_ar")
                                                         <span class="text-danger">{{ $message }}</span>
                                                         @enderror
