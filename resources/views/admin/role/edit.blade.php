                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> Edit {{ $role->name }} </h4>
                                                ...
                                                @foreach (config('global.permissions') as $name => $value)
                                                    <div class="form-group col-sm-4">
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="permissions[]" value=" {{ in_array($name , $role->permissions) ? 'checked' : '' }}" id="permissions" class="chk-box"> {{ $value }}</label>
                                                    </div>
                                                @endforeach
                                                @error("permissions")
                                                    <span class="text-danger">{{ $message }}</span>
