    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item active"><a href=""><i class="la la-mouse-pointer"></i><span
                class="menu-title" data-i18n="nav.add_on_drag_drop.main">The Main</span></a>
            </li>

              @can('mainCategories')
                     <li class="nav-item"><a href=""><i class="la la-group"></i>
                            <span class="menu-title" data-i18n="nav.dash.main">Main Stores </span>
                            <span class="badge badge badge-danger badge-pill float-right mr-2"> {{ App\Models\MainCategory::count() }}</span> </a>
                            <ul class="menu-content">
                            <li class="active"><a class="menu-item" href="{{ route('admin.mainCategories') }}" data-i18n="nav.dash.ecommerce">Show All</a></li>
                            <li><a class="menu-item" href="{{ route('admin.mainCategories.create') }}" data-i18n="nav.dash.crypto">Add Main Category</a> </li>
                            </ul>
                     </li>
              @endcan
               ...
               @can('mainCategories')
                     <li class="nav-item"><a href=""><i class="la la-group"></i>
                            <span class="menu-title" data-i18n="nav.dash.main"> Splash Screen </span>
                            <span class="badge badge badge-danger badge-pill float-right mr-2"> {{ App\Models\SplashScreen::count() }}</span> </a>
                            <ul class="menu-content">
                            <li class="active"><a class="menu-item" href="{{ route('admin.splashScreen') }}" data-i18n="nav.dash.ecommerce">Show All</a></li>
                            <li><a class="menu-item" href="{{ route('admin.splashScreen.create') }}" data-i18n="nav.dash.crypto">Add Splash Screen</a> </li>
                            </ul>
                     </li>
              @endcan
              ...
              @can('mainCategories')
                     <li class="nav-item"><a href=""><i class="la la-group"></i>
                            <span class="menu-title" data-i18n="nav.dash.main"> Count Down </span>
                            <span class="badge badge badge-danger badge-pill float-right mr-2"> {{ App\Models\CountDown::count() }}</span> </a>
                            <ul class="menu-content">
                            <li class="active"><a class="menu-item" href="{{ route('admin.countDowns') }}" data-i18n="nav.dash.ecommerce">Show All</a></li>
                            <li><a class="menu-item" href="{{ route('admin.countDowns.create') }}" data-i18n="nav.dash.crypto">Add Count Down</a> </li>
                            </ul>
                     </li>
              @endcan
               ...
               @can('mainCategories')
              <li class="nav-item"><a href=""><i class="la la-group"></i>
                     <span class="menu-title" data-i18n="nav.dash.main"> Pop up Offers </span>
                     <span class="badge badge badge-danger badge-pill float-right mr-2"> {{ App\Models\PopUp::count() }}</span> </a>
                     <ul class="menu-content">
                     <li class="active"><a class="menu-item" href="{{ route('admin.PopUp') }}" data-i18n="nav.dash.ecommerce">Show All</a></li>
                     <li><a class="menu-item" href="{{ route('admin.PopUp.create') }}" data-i18n="nav.dash.crypto">Add New Popup</a> </li>
                     </ul>
              </li>
              @endcan
              ...
              @can('sellers')
                     ...
                     <span class="menu-title" data-i18n="nav.dash.main">Stores</span>
                            <ul class="menu-content">
                                   <li class="active"><a class="menu-item" href="{{ route('admin.sellers') }}"
                                          data-i18n="nav.dash.ecommerce"> Sellers 
                                          <span class="badge badge badge-success badge-pill float-right mr-2">{{ App\Models\Seller::count() }}</span>                                   
                                          </a>                                   
                                   </li>
                                   <li><a class="menu-item" href="{{ route('admin.sellers.create') }}" 
                                                 data-i18n="nav.dash.crypto">Add New Seller</a>
                                   </li>
                            </ul>
                            <ul class="menu-content">
                                   @can('locations')
                                          <li class="active"><a class="menu-item" href="{{ route('admin.locations') }}"
                                                 data-i18n="nav.dash.ecommerce"> Locations 
                                                 <span class="badge badge badge-info badge-pill float-right mr-2">{{ App\Models\Location::count() }}</span>
                                          </a>
                                          </li>
                                          <li><a class="menu-item" href="{{ route('admin.locations.create') }}" 
                                                 data-i18n="nav.dash.crypto">Add New Location</a>
                                          </li>
                                   @endcan
                            </ul>
                     </li>
              ...
              @can('products')
                     <li class="nav-item"><a href=""><i class="la la-male"></i>
                            <span class="menu-title" data-i18n="nav.dash.main">Products</span></a>
                            <ul class="menu-content">
                                   @can('categories')
                                          <li class="active">
                                                 <a class="menu-item" href="{{ route('admin.categories') }}"
                                                        ...
                                                        <span class="badge badge badge-danger badge-pill float-right mr-2">
                                                               ...
                                                               @if(Auth::user()->seller_id == $seller->id)
                                                                      {{ App\Models\Category::where('main_category_id',$seller->main_category_id)->count()}}
                                                               @endif
                                                               @endforeach  
                                                               @endif
                                                        </span>
                                          ...
                                          <li>
                                                 <a class="menu-item" href="{{ route('admin.categories.create') }}" data-i18n="nav.dash.crypto">Add New Category </a>
                                          </li>
                                    @endcan
                                    @can('categories')
                                          <li class="active">
                                                 <a class="menu-item" href="{{ route('admin.categorySlider') }}"
                                                        data-i18n="nav.dash.ecommerce"> Category Slider
                                                        <span class="badge badge badge-danger badge-pill float-right mr-2">
                                                               @if (Auth::user()->is_supervisor == 1)
                                                                      {{ App\Models\CategoryImages::count() }}
                                                               @endif
                                                        </span>
                                                 </a>
                                          </li>
                                          <li>
                                                 <a class="menu-item" href="{{ route('admin.categorySlider.create') }}" data-i18n="nav.dash.crypto">Add New Category Image </a>
                                          </li>
                                   @endcan
                            </ul>
                                   ...
                                   @can('subCategories')
                                          <ul class="menu-content">
                                                 <li class="active"><a class="menu-item" href="{{ route('admin.subCategories') }}"
                                                        data-i18n="nav.dash.ecommerce"> Sub Categories 
                                                        <span class="badge badge badge-success  badge-pill float-right mr-2">
                                                               ...
                                                               @else
                                                                      @foreach ($sellers as $seller)
                                                                             @if(Auth::user()->seller_id == $seller->id)
                                                                                    {{ App\Models\SubCategory::where('main_category_id',$seller->main_category_id)->count()}}
                                                                             @endif
                                                                      @endforeach    
                                                               @endif
                                                 ...
                                                 <li>
                                                        ...
                                                        data-i18n="nav.dash.crypto">Add Sub Category</a>
                                                 </li>
                                          </ul>
                                   @endcan
                                   @can('subCategories')
                                          <ul class="menu-content">
                                                 <li class="active">
                                                        <a class="menu-item" href="{{ route('admin.promoCategories') }}"
                                                        data-i18n="nav.dash.ecommerce"> Promo Categories 
                                                        <span class="badge badge badge-success  badge-pill float-right mr-2">
                                                               {{ App\Models\PromoCategories::count() }}
                                                        </span>
                                                        </a>
                                                 </li>
                                                 <li>
                                                        <a class="menu-item" href="{{ route('admin.promoCategories.create') }}" 
                                                        data-i18n="nav.dash.crypto">Add New Promo</a>
                                                 </li>
                                          </ul>
                                   @endcan       
                            </ul>
                            ...
                            <ul class="menu-content">
                                   @can('subSubCategories')
                                          <ul class="menu-content">
                                                 <li class="active">
                                                        <a class="menu-item" href="{{ route('admin.subSubCategories') }}"
                                                               data-i18n="nav.dash.ecommerce"> Sub Sub Category
                                                               <span class="badge badge badge-info  badge-pill float-right mr-2">
                                                                      @if (Auth::user()->is_supervisor == 1)
                                                                             {{ App\Models\Sub_Sub_Category::count() }}
                                                                      @else
                                                                             @foreach ($sellers as $seller)
                                                                                    @if(Auth::user()->seller_id == $seller->id)
                                                                                           {{ App\Models\Sub_Sub_Category::where('main_category_id',$seller->main_category_id)->count()}}
                                                                                    @endif
                                                                             @endforeach    
                                                                      @endif
                                                 ...
                                                 <li>
                                                        <a class="menu-item" href="{{ route('admin.subSubCategory.create') }}" 
                                                        data-i18n="nav.dash.crypto">Add Sub Sub Category</a>
                                                 </li>
                                          </ul>
                                   @endcan                                   
                            </ul>
                           ...
                           <ul class="menu-content">
                                   @can('tags')
                                          <ul class="menu-content">
                                                 <li class="active"><a class="menu-item" href="{{ route('admin.productTags') }}"
                                                        data-i18n="nav.dash.ecommerce">
                                                        <span class="menu-title" data-i18n="nav.dash.main">Tags</span>
                                                        <span
                                                        class="badge badge badge-warning badge-pill float-right mr-2">{{ App\Models\ProductTags::count() }}</span>
                                                        </a>
                                                 </li>
                                                 <li>
                                                        <a class="menu-item" href="{{ route('admin.productTags.create') }}" 
                                                        data-i18n="nav.dash.crypto">Add New Tag</a>
                                                 </li>
                                          </ul>
                                          <ul class="menu-content">
                                                 <li class="active"><a class="menu-item" href="{{ route('admin.tagsProducts') }}"
                                                        data-i18n="nav.dash.ecommerce">
                                                        <span class="menu-title" data-i18n="nav.dash.main">Product Tags</span>
                                                        <span
                                                        class="badge badge badge-warning badge-pill float-right mr-2">{{ App\Models\TagsProducts::count() }}</span>
                                                        </a>
                                                 </li>
                                                 <li>
                                                        <a class="menu-item" href="{{ route('admin.tagsProducts.create') }}" 
                                                        data-i18n="nav.dash.crypto">Add New Product Tags</a>
                                                 </li>
                                          </ul>
                                   @endcan
                            ...
                            <ul class="menu-content">
                                   <li class="active">
                                          ...
                                          data-i18n="nav.dash.ecommerce"> Products
                                          <span class="badge badge badge-info  badge-pill float-right mr-2">
                                                 @if (Auth::user()->is_supervisor == 1){{ App\Models\Product::count() }}@else
                                                        @foreach ($sellers as $seller) @if (Auth::user()->seller_id == $seller->id){{ App\Models\Product::where('seller_id' , $seller->id)->count() }}@endif       
                                                        @endforeach
                                                 @endif
                                          </span>
                                          </a>
                                   ...
                                   <li>
                                          <a class="menu-item" href="{{ route('admin.products.create') }}" data-i18n="nav.dash.crypto">Add New Product</a>
                                   </li>
                                   <li>
                                          <a class="menu-item" href="{{ route('admin.productImages.create') }}" data-i18n="nav.dash.crypto">Add New Product Images</a>
                                   </li>
                                   <li>
                                          <a class="menu-item" href="{{ route('admin.variants.create') }}" data-i18n="nav.dash.crypto">Add New Product Variant</a>
                                   </li>
                             ...
                             <ul class="menu-content">
                                   <li class="active">
                                          <a class="menu-item" href="{{ route('admin.topSellings') }}"
                                          data-i18n="nav.dash.ecommerce"> Top Selling
                                          <span class="badge badge badge-info  badge-pill float-right mr-2">
                                                 {{ App\Models\TopSelling::count() }}
                                          </span>
                                          </a>
                                   </li>
                                   <li>
                                          <a class="menu-item" href="{{ route('admin.topSellings.create') }}" data-i18n="nav.dash.crypto">Add New Top Selling</a>
                                   </li>
                            </ul>

                            <ul class="menu-content">
                                   <li class="active">
                                          <a class="menu-item" href="{{ route('admin.newArrivals') }}"
                                          data-i18n="nav.dash.ecommerce"> New Arrival
                                          <span class="badge badge badge-info  badge-pill float-right mr-2">
                                                 {{ App\Models\NewArrival::count() }}
                                          </span>
                                          </a>
                                   </li>
                                   <li>
                                          <a class="menu-item" href="{{ route('admin.newArrivals.create') }}" data-i18n="nav.dash.crypto">Add New Arrival</a>
                                   </li>
                            </ul>


                            <ul class="menu-content">
                                   @can('related_products')
                                          <ul class="menu-content">
                                                 <li class="active">
                                                        <a class="menu-item" href="{{ route('admin.related_products') }}"
                                                        data-i18n="nav.dash.ecommerce"> Related Products
                                                        <span class="badge badge badge-danger  badge-pill float-right mr-2">
                                                               @if (Auth::user()->is_supervisor == 1){{ App\Models\RelatedProducts::count() }} @endif
                                                        </span>
                                                        </a>
                                                 </li>
                                                 <li>
                                                        <a class="menu-item" href="{{ route('admin.related_products.create') }}" data-i18n="nav.dash.crypto">Add New Relation</a>
                                                 </li>
                                          </ul>
                                   @endcan
                            </ul>
                            ...
                            <ul class="menu-content">
                                   @can('review_products')
                                          <ul class="menu-content">
                                                 <li class="active">
                                                        <a class="menu-item" href="{{ route('admin.review_products') }}"
                                                        data-i18n="nav.dash.ecommerce"> Review Products
                                                        <span class="badge badge badge-success  badge-pill float-right mr-2">
                                                               @if (Auth::user()->is_supervisor == 1){{ App\Models\ReviewProducts::count() }} @endif
                                                        </span>
                                                        </a>
                                                 </li>
                                                 <li>
                                                        <a class="menu-item" href="{{ route('admin.review_products.create') }}" data-i18n="nav.dash.crypto">Add New Review</a>
                                                 </li>
                                          </ul>
                                   @endcan
                            </ul>
                            ...
                            <ul class="menu-content">
                                   @can('dealsBanners')
                                          <ul class="menu-content">
                                                 <li class="active">
                                                        <a class="menu-item" href="{{ route('admin.dealsBanners') }}"
                                                        data-i18n="nav.dash.ecommerce"> Deals
                                                        <span class="badge badge badge-success  badge-pill float-right mr-2">
                                                               @if (Auth::user()->is_supervisor == 1){{ App\Models\Deals::count() }} @endif
                                                        </span>
                                                        </a>
                                                 </li>
                                                 <li>
                                                        <a class="menu-item" href="{{ route('admin.dealsBanners.create') }}" data-i18n="nav.dash.crypto">Add New Deal</a>
                                                 </li>
                                          </ul>
                                   @endcan
                            </ul>                            
                            ...
                            <ul class="menu-content">
                                   @can('recommended_products')
                                          <ul class="menu-content">
                                                 <li class="active">
                                                        <a class="menu-item" href="{{ route('admin.recommended_products') }}"
                                                        data-i18n="nav.dash.ecommerce"> Recommended Products
                                                        <span class="badge badge badge-info  badge-pill float-right mr-2">
                                                               @if (Auth::user()->is_supervisor == 1){{ App\Models\RecomendedProducts::count() }} @endif
                                                        </span>
                                                        </a>
                                                 </li>
                                                 <li>
                                                        <a class="menu-item" href="{{ route('admin.recommended_products.create') }}" data-i18n="nav.dash.crypto">Add New Recommendation</a>
                                                 </li>
                                          </ul>
                                   @endcan
                            </ul>
              ...
              @can('wheel')
              <li class="nav-item"><a href=""><i class="la la-male"></i>
                     <span class="menu-title" data-i18n="nav.dash.main">Wheel Gifts</span></a>

                     <ul class="menu-content">
                            @can('wheel')
                                   <ul class="menu-content">
                                          <li class="active"><a class="menu-item" href="{{ route('admin.wheel') }}"
                                                 data-i18n="nav.dash.ecommerce">
                                                 <span class="menu-title" data-i18n="nav.dash.main">Gifts Whell</span>
                                                 <span
                                                 class="badge badge badge-warning  badge-pill float-right mr-2">{{ App\Models\Wheel::count() }}</span>
                                                 </a>
                                          </li>
                                          <li>
                                                 <a class="menu-item" href="{{ route('admin.wheel.create') }}" 
                                                 data-i18n="nav.dash.crypto">Add New Gift</a>
                                          </li>
                                   </ul>
                            @endcan                                          
                     </ul>
                     ...
                     <ul class="menu-content">
                            @can('gifts_users')
                                   <li class="active">
                                          <a class="menu-item" href="{{ route('admin.gifts_users') }}"
                                                 data-i18n="nav.dash.ecommerce"> Customers Gifts
                                                 <span class="badge badge badge-danger badge-pill float-right mr-2">
                                                        @if (Auth::guard('admin')->user()->is_supervisor == 1)
                                                        {{ App\Models\GiftsUsers::count() }}
                                                        @else
                                                               @foreach ($sellers as $seller)
                                                                      @if(Auth::user()->seller_id == $seller->id)
                                                                             {{ App\Models\GiftsUsers::where('user_id',$customer->id)->count()}}
                                                                      @endif
                                                               @endforeach  
                                                        @endif
                                                 </span>
              ...
              @can('chat')
              <li class="nav-item"><a href=""><i class="la la-male"></i>
                     <span class="menu-title" data-i18n="nav.dash.main">Chat & Notifications</span></a>

                     <!--<ul class="menu-content">-->
                     <!--       @can('chat')-->
                     <!--              <ul class="menu-content">-->
                     <!--                     <li class="active"><a class="menu-item" href="{{ route('admin.chat') }}"-->
                     <!--                            data-i18n="nav.dash.ecommerce">-->
                     <!--                            <span class="menu-title" data-i18n="nav.dash.main">Chat Room</span>-->
                     <!--                            <span-->
                     <!--                            class="badge badge badge-warning  badge-pill float-right mr-2">{{ App\Models\Chat::count() }}</span>-->
                     <!--                            </a>-->
                     <!--                     </li>-->
                     <!--                     <li>-->
                     <!--                            <a class="menu-item" href="{{ route('admin.chat.create') }}" -->
                     <!--                            data-i18n="nav.dash.crypto">Add New Chat</a>-->
                     <!--                     </li>-->
                     <!--              </ul>-->
                     <!--       @endcan                                          -->
                     <!--</ul>-->
                     ...
                     <ul class="menu-content">
                            @can('notifications')
                                   <li class="active">
                                          <a class="menu-item" href="{{ route('admin.notifications') }}"
                                                 data-i18n="nav.dash.ecommerce"> Notifications
                                                 <span class="badge badge badge-danger badge-pill float-right mr-2">
                                                        @if (Auth::guard('admin')->user()->is_supervisor == 1)
                                                        ...
                                                        @else
                                                               @foreach ($sellers as $seller)
                                                                      @if(Auth::user()->seller_id == $seller->id)
                                                                             {{ App\Models\Notification::where('user_id',$customer->id)->count()}}
                                                                      @endif
                                                               @endforeach  
                                                        @endif
                                                 </span>
                                   ...
                                   <li>
                                          <a class="menu-item" href="{{ route('admin.notifications.create') }}" 
                                          data-i18n="nav.dash.crypto">Add New Notification</a>
                                   </li>
                            @endcan
                     </ul>
                     ...
                     <ul class="menu-content">
                            @can('chatBot')
                                   <li class="active">
                                          <a class="menu-item" href="{{ route('admin.chatBot') }}"
                                                 data-i18n="nav.dash.ecommerce"> Chat Bots
                                                 <span class="badge badge badge-danger badge-pill float-right mr-2">
                                                        @if (Auth::guard('admin')->user()->is_supervisor == 1)
                                   ...
                                   <li>
                                          <a class="menu-item" href="{{ route('admin.chatBot.create') }}" 
                                          data-i18n="nav.dash.crypto">Add New Chat Bot</a>
                                   </li>
                            @endcan
                     </ul>
              </li>
              @endcan
               @can('installment')
                     <li class="nav-item"><a href=""><i class="la la-male"></i>
                     <span class="menu-title" data-i18n="nav.dash.main">Installment</span>
                            <ul class="menu-content">
                                   <li class="active"><a class="menu-item" href="{{ route('admin.installments') }}"
                                          data-i18n="nav.dash.ecommerce"> Installment Types 
                                          <span class="badge badge badge-success badge-pill float-right mr-2">{{ App\Models\Installments::count() }}</span>                                   
                                          </a>                                   
                                   </li>
                                   <li><a class="menu-item" href="{{ route('admin.installments.create') }}" 
                                                 data-i18n="nav.dash.crypto">Add New Installment</a>
                                   </li>
                            </ul>
                            <ul class="menu-content">
                                   @can('installment')
                                          <li class="active"><a class="menu-item" href="{{ route('admin.installmentForm') }}"
                                                 data-i18n="nav.dash.ecommerce"> Installment Form 
                                                 <span class="badge badge badge-info badge-pill float-right mr-2">{{ App\Models\InstallmentsForm::count() }}</span>
                                          </a>
                                          </li>
                                   @endcan
                            </ul>
              ...
              @endcan
                     ...
                     <li class="nav-item">
                            ...
                            <ul class="menu-content">
                                   <li class="active">
                                          <a class="menu-item" href="{{ route('admin.roles') }}"
                                          data-i18n="nav.dash.ecommerce"> Roles 
                                          <span class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\Role::count() }}</span>
                                          </a>
                                   </li>
                                   <li>
                                          <a class="menu-item" href="{{ route('admin.roles.create') }}" 
                                          data-i18n="nav.dash.crypto">Add New Role</a>
                                   </li>
                            </ul>
                            @endcan
                            @can('users')
                                   <ul class="menu-content">
                                          ...
                                          <li class="active"><a class="menu-item" href="{{ route('admin.users') }}"
                                                 data-i18n="nav.dash.ecommerce"> All Users 
                                                 <span class="badge badge badge-success badge-pill float-right mr-2">{{ App\Models\Admin::count() }}</span>  
                                                 </a>
                                          </li>
                                          <li>
                                                 <a class="menu-item" href="{{ route('admin.users.create') }}" 
                                                 data-i18n="nav.dash.crypto">Add New User</a>
                                          </li>
                                          </ul>
                                   </ul>
                            @endcan              
                            @can('ApiUser')
                                   <ul class="menu-content">
                                          <ul class="menu-content">
                                          <li class="active"><a class="menu-item" href="{{ route('admin.userApi') }}"
                                                 data-i18n="nav.dash.ecommerce"> All API Users 
                                                 <span class="badge badge badge-info badge-pill float-right mr-2">{{ App\Models\Api_admin::count() }}</span>  
                                                 </a>
                                          </li>
                                          <li>
                                                 <a class="menu-item" href="{{ route('admin.userApi.create') }}" 
                                                 data-i18n="nav.dash.crypto">Add New API User</a>
                                          </li>
                                          </ul>
                                   </ul>              
                            @endcan
                     ...
                     <li class="nav-item">
                            <a href=""><i class="la la-male"></i>
                                   <span class="menu-title" data-i18n="nav.dash.main">Discount</span>
                            </a>                     
                            <ul class="menu-content">
                                   <li class="active">
                                          <a class="menu-item" href="{{ route('admin.discount.create') }}"
                                          data-i18n="nav.dash.ecommerce"> Create Discount
                                          <!-- <span class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\Role::count() }}</span> -->
                                          </a>
                                   </li>
                                   <li>
                                          <a class="menu-item" href="{{ route('admin.discount.show') }}" 
                                          data-i18n="nav.dash.crypto">Show All Discount</a>
                                   </li>
                            </ul>
              ...
              {{-- @foreach ($sellers as $seller)    
                     @if (Auth::user()->email == $seller->email)
                            <li class="nav-item">
                                   <a href=""><i class="la la-male"></i>
                                          <span class="menu-title" data-i18n="nav.dash.main">Financials</span>
                                   </a>                     
                                   <ul class="menu-content">
                                          <li class="active">
                                                 <a class="menu-item" href="{{ route('admin.roles') }}"
                                                        data-i18n="nav.dash.ecommerce"> Account Summary 
                                                 </a>
                                          </li>
                                          <li class="active">
                                                 <a class="menu-item" href="{{ route('admin.roles') }}"
                                                        data-i18n="nav.dash.ecommerce"> Request Withdrwal 
                                                 </a>
                                          </li>
                                          <li class="active">
                                                 <a class="menu-item" href="{{ route('admin.roles') }}"
                                                        data-i18n="nav.dash.ecommerce"> Withdrwal Status 
                                                 </a>
                                          </li>
                                          <li class="active">
                                                 <a class="menu-item" href="{{ route('admin.roles') }}"
                                                        data-i18n="nav.dash.ecommerce"> Compensations 
                                                 </a>
                                          </li>     
                                   </ul>                            
                            </li>
