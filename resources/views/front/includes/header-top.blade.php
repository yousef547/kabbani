            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 d-flex justify-content-end align-items-center header-top-right">
                    <div class="register-out">
                        ...
                        <a class="register" href="{{ route('customer.register') }}" data-link-action="display-register-form">
                            Register
                        </a>
                        <span class="or-text">or</span>
                        <a class="login" href="{{ route('customer.login') }}" rel="nofollow" title="Login to your account">Login</a> --}}
                    </div>
